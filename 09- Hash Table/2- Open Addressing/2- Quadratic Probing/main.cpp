...
int main() {
    ...
    table.insert(StudentData("mohand" , "200365")) ;    // 0
    table.insert(StudentData("mohsen" , "20220365")) ;  // 0
    ...
    table.remove(StudentData("ali" , "200135")) ;
    cout << "After remove mohamed and ali : \n" ;
